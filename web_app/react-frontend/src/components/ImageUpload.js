  ...
  render() {
    return (
      <div className="container mt-5 main">
        ...
        <div className="row mr-auto ml-auto border p-4 shadow sm mb-5 bg-white rounded">
          ...
          <div className="col-sm-12 col-lg-6">
            <br />
            <h3 className="text-center">Predicted Disease</h3>
            ...
            <br />
            <br />
            <h3 className="text-center">Prediction Graph</h3>
            <img
